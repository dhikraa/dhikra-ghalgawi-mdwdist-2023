...
import GestionActualite from './GestionActualite';
    ...
    <Tabs selected={0}>
      <TabList>
        <Tab>
          ...
          <Button >Gestion des Commercants </Button>
        </Tab>
        <Tab>
          <Button>Gestion des utilisateurs</Button>
        </Tab>
        <Tab>
          <Button>Gestion des actualités </Button>
        </Tab>
      </TabList>

      <TabPanel>
      Gestion des Commercants <Services />
      </TabPanel>
    
      <TabPanel>
      Gestion des utilisateurs <GestionUtilisateurs />
      </TabPanel>

      <TabPanel>
      Gestion des actualités <GestionActualite/>
